...
NKall[which(NKall[,1]==""),]
#pocet radku NKall je 293541. ok.
...
cp NKall6.txt NKall.txt                         #zkopirovani schvaleneho souboru NKall
...
rm NKall2.txt NKall3.txt NKall4.txt NKall5.txt NKall6.txt 

#smazani pracovnich souboru NKB
rm NKB1.txt NKB2.txt NKB3.txt NKB2b2.txt
